 ...
 * ************************** */
async function addInventory(inv_make, inv_model, inv_year, classification_id, inv_price, inv_miles, inv_description, inv_color, inv_image) {
  try {
    const result = await pool.query(
      ...
      [inv_make, inv_model, inv_year, classification_id, inv_price, inv_miles, inv_description, inv_color, inv_image]
    );
